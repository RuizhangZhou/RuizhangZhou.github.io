...
- Admin-Oberfläche (Vue 3 + Inertia): Modell- und Deploymentverwaltung, Parameter (Temperature / Top-p / Penalties), Reasoning-Effort (o1 / o3-mini), System-Prompts, Quoten; Soft-Delete und Restore; automatische Deaktivierung bei Credential-Entzug.
